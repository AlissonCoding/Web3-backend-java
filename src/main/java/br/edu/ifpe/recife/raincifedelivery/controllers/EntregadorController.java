...
import br.edu.ifpe.recife.raincifedelivery.model.repositories.EntregadorRepository;
 ...
 * @author Alisson
 */
@WebServlet(name = "EntregadorController", urlPatterns = {"/Entregador"})
public class EntregadorController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        EntregadorRepository repository = new EntregadorRepository();
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Entregador</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Entregador cadastrado</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
